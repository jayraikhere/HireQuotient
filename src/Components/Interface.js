    ...
    return (
        <div className="container">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px' }}>
                ...
                <button className="delete-selected" onClick={handleDeleteSelected}>Delete Selected <img style={{ height: "12px" }} src={process.env.PUBLIC_URL + '/Icons/bin.png'} alt="Delete" /></button>
            </div>
            <table>
                <thead>
                    <tr>
